import"./hoisted.CaEvvjRJ.js";const n=document.getElementById("payment-form");n?.addEventListener("submit",async o=>{o.preventDefault();const e=n.querySelector('button[type="submit"]');e.textContent,e.disabled=!0,e.innerHTML=`
